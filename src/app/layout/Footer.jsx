...
const Footer = () => {
    return (
        <div className="h-screen bg-black text-white px-28 pt-12 flex flex-col">
            <div className="w-full flex gap-x-7 items-center h-60 border-b border-b-[rgba(255,255,255,0.3)]">
                ...
                <div className="flex gap-x-2 mb-2">
                    <input type="text" className="h-16 w-96 px-4 placeholder:text-sm text-black placeholder:text-black outline-none none" placeholder="Enter your email" />
                    <button className="bg-red-500 px-10 py-5 font-semibold hover:bg-transparent border border-red-500 hover:text-red-500">Subscribe</button>
                </div>
                <div className="flex gap-x-3 ml-10 mb-12">
            ...
            <div className="grid grid-cols-5 grid-rows-1 h-96 pt-12 border-b border-b-[rgba(255,255,255,0.3)]">
