...
const Footer = () => {
    ...
    return (
        <div className="h-screen bg-black text-white px-28 pt-12 flex flex-col sm:px-5 sm:pt-8 sm:h-auto md:px-10 md:pt-10 md:h-auto hidden-animation opacity-0 -translate-y-[100px] sm:translate-y-0 transition-all duration-500 sm:duration-100 sm:transition-none sm:opacity-100">
