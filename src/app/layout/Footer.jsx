...
const Footer = () => {
    ...
    return (
        <div className="h-screen bg-black text-white px-28 pt-12 flex flex-col sm:px-5 sm:pt-8 sm:h-auto md:px-10 md:pt-10 md:h-auto md:hidden-animation md:opacity-0 md:-translate-y-[100px] md:transition-all md:duration-1000 lg:hidden-animation lg:opacity-0 lg:-translate-y-[100px] lg:transition-all lg:duration-1000">
