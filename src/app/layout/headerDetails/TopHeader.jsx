...
export const TopHeader = ({country, currencySymbol, setCountry}) => {
    return (
        <div className="w-full h-8 px-20 flex items-center justify-between bg-white border-b text-sm sm:justify-center sm:px-0">
            ...
            <div className="w-5/12 grid grid-cols-3 divide-x divide-gray-300 gap-x-5 text-sm sm:w-full sm:flex sm:divide-none sm:items-center sm:justify-center sm:space-x-0 sm:text-sm">
