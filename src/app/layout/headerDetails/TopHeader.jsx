...
export const TopHeader = ({country, currencySymbol, setCountry}) => {
    return (
        <div className="w-full h-8 px-20 flex items-center justify-between bg-white border-b text-sm sm:justify-center sm:px-0 md:px-5">
            <div className="flex items-center justify-center gap-x-5 text-sm sm:hidden">
                <Link href="">About Us</Link>
                <Link href="">Privacy</Link>
                <Link href="">FAQ</Link>
            </div>
            <div className="w-5/12 grid grid-cols-3 divide-x divide-gray-300 gap-x-5 text-sm sm:w-full sm:flex sm:divide-none sm:items-center sm:justify-center sm:space-x-0 sm:text-sm md:w-fit">
                <Link href="" className="w-full text-center sm:hidden">My Wishlist</Link>
                <Link href="" className="w-full text-center sm:hidden">Track Your Order</Link>
                <div className="flex items-center justify-center space-x-4 text-gray-500 sm:px-5 md:pl-5">
