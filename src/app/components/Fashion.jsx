...
const Fashion = () => {
    return (
        <div className="w-full px-20 my-8 flex gap-x-10 items-center justify-center z-10 sm:px-5 sm:flex-col sm:space-y-5">
            <div className="size-80 sm:size-96 flex flex-col items-center justify-end text-xl font-bold text-white overflow-hidden bg-gray-800 group">
