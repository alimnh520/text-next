...
const Fashion = () => {
    return (
        <div className="w-full px-20 my-8 flex gap-x-10 items-center justify-center z-10 sm:px-10 sm:flex-col sm:space-y-8 md:px-10 md:gap-x-5">
            <div className="size-80 flex flex-col items-center justify-end text-xl font-bold text-white overflow-hidden bg-gray-800 group hidden-animation opacity-0 -translate-y-[100px] transition-all duration-1000">
