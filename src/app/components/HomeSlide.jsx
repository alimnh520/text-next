...
const HomeSlide = () => {
    return (
        <Swiper
            ...
            slidesPerView={1}
            loop={true}
            className='h-screen relative flex justify-center w-full text-white mt-20 sm:h-96'
        >
            ...
            <SwiperSlide>
                <div className="relative pl-20 sm:pl-5 w-full h-full bg-blue-700 bg-cover bg-center flex items-center justify-between">
                    <div className="w-1/2 h-full flex flex-col items-start justify-center gap-y-6 uppercase animate-fadeInUp">
                        ...
                        <p className="mt-4 sm:mt-0 text-6xl sm:text-4xl leading-normal font-semibold">Man Sunglasses Collection
                        </p>
            ...
            <SwiperSlide>
                <div className="relative pl-20 sm:pl-5 w-full h-full bg-blue-950 bg-cover bg-center flex items-center justify-between">
                    <div className="w-1/2 h-full flex flex-col items-start justify-center gap-y-6 uppercase animate-fadeInUp">
                        ...
                        <p className="mt-4 sm:mt-0 text-6xl sm:text-4xl leading-normal font-semibold">Woman Sunglasses Collection
                        </p>
                        <button className='px-16 sm:px-8 py-4 sm:py-2 sm:text-base  border border-white text-white text-lg hover:border-red-500 hover:bg-red-500 font-bold transition-all duration-300'>Shop Now</button>
                    </div>
            ...
            <SwiperSlide>
                <div className="relative pl-20 sm:pl-5 w-full h-full bg-rose-600 bg-cover bg-center flex items-center justify-between">
                    <div className="w-1/2 h-full flex flex-col items-start justify-center gap-y-6 uppercase animate-fadeInUp">
                        ...
                        <p className="mt-4 sm:mt-0 text-6xl sm:text-4xl leading-normal font-semibold">Kid Sunglasses Collection
                        </p>
                        <button className='px-16 sm:px-8 py-4 sm:py-2 sm:text-base  border border-white text-white text-lg hover:border-red-500 hover:bg-red-500 font-bold transition-all duration-300'>Shop Now</button>
                    </div>
