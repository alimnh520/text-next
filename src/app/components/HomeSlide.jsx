...
const HomeSlide = () => {
    return (
        <Swiper
            ...
            slidesPerView={1}
            loop={true}
            className='h-screen relative flex justify-center w-full text-white mt-20 sm:h-[410px] md:mt-48 md:h-[700px] text-5xl opacity-0 -translate-y-[100px] transition-all duration-500 hidden-animation'
        >
