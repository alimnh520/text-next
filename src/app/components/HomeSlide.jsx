...
const HomeSlide = () => {
    return (
        <Swiper
            ...
            slidesPerView={1}
            loop={true}
            className='h-screen relative flex justify-center w-full text-white mt-20 sm:h-[410px] md:mt-48 md:h-[700px] text-5xl opacity-0 -translate-y-[100px] transition-all duration-1000 hidden-animation'
        >
            ...
            <SwiperSlide>
                <div className="relative pl-20 sm:pl-5 md:pl-10 w-full h-full bg-blue-700 bg-cover bg-center flex items-center justify-between">
                    <div className="w-1/2 h-full flex flex-col items-start justify-center gap-y-6 uppercase animate-fadeInUp sm:gap-y-0 md:gap-y-0 sm:justify-end sm:pb-10">
            ...
            <SwiperSlide>
                <div className="relative pl-20 sm:pl-5 md:pl-10 w-full h-full bg-blue-950 bg-cover bg-center flex items-center justify-between">
                    <div className="w-1/2 h-full flex flex-col items-start justify-center gap-y-6 uppercase animate-fadeInUp sm:gap-y-0 md:gap-y-0 sm:justify-end sm:pb-10">
                        <h2 className="flex items-center justify-center text-4xl sm:text-3xl font-bold text-red-500 animate-fadeLeft">
                            <div className='h-1 w-20 bg-red-500 sm:hidden'></div> version 2021
                        </h2>
            ...
            <SwiperSlide>
                <div className="relative pl-20 sm:pl-5 md:pl-10 w-full h-full bg-rose-600 bg-cover bg-center flex items-center justify-between">
                    <div className="w-1/2 h-full flex flex-col items-start justify-center gap-y-6 uppercase animate-fadeInUp sm:gap-y-0 md:gap-y-0 sm:justify-end sm:pb-10">
