...
const Discount = () => {
    return(
        <div className="w-full h-24 bg-red-300 flex items-center justify-center gap-x-5 my-6 sm:h-auto sm:flex-col sm:py-5 sm:space-y-5 md:h-auto md:flex-col md:py-5 md:space-y-5">
