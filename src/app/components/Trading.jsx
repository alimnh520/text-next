    ...
    return (
        <div className="flex flex-col px-28 py-10 w-full h-[700px] sm:h-auto sm:px-5 md:px-5 md:h-auto">
            <nav className="space-x-4 mb-8 flex items-center justify-between border-b border-b-gray-200 sm:flex-col md:flex-col md:mb-4">
                <p className='text-4xl font-semibold hidden-animation opacity-0 -translate-x-[200px] sm:transform-none transition-all duration-500'>Trending This Week</p>
                <div className="flex items-center justify-center gap-x-5 hidden-animation opacity-0 translate-x-[200px] sm:transform-none transition-all duration-500 sm:gap-x-3">
                    <button
            ...
            <div className="p-6 rounded shadow-lg w-full hidden-animation opacity-0 -translate-y-[100px] transition-all duration-500">
                {content === "men" && (
                    <div>
