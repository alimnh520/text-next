...
const page = () => {
    return (
        <div className="flex flex-col w-full">
            <div className="w-full mt-20 h-40 gap-y-5 bg-red-100 flex flex-col items-center justify-center sm:h-28 md:mt-48">
                <p className="text-3xl font-bold text-black">Blogs</p>
                <div className="grd grid-cols-2 text-sm text-gray-600 divide-x-2 divide-gray-600 md:flex md:justify-center md:mr-20">
